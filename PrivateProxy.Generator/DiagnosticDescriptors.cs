...
public static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor GenericsNotSupported = new(
         ...
         messageFormat: "The PrivateProxy does not support generics type'{0}'",
         category: Category,
         defaultSeverity: DiagnosticSeverity.Error,
         isEnabledByDefault: true);
    public static readonly DiagnosticDescriptor BoundedGenericsNotSupported = new(
        id: "PP008",
        title: "PrivateProxy does not support bounded generics type",
        messageFormat: "The PrivateProxy does not support bounded generics type'{0}'",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    public static readonly DiagnosticDescriptor InValidConstraints = new(
       id: "PP009",
       title: "PrivateProxy does not support bounded generics type",
       messageFormat: "The PrivateProxy does not support bounded generics type'{0}'",
       category: Category,
